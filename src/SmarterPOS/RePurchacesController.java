...
public class RePurchacesController implements Initializable{
    ...
    public void AddOrderRow()
    {
        try {
            ...
            if(! MP.AddRePurRowTable(UnitNameTB.getText(), QtyTB.getText(), PriceTB.getText(), discountTB.getText(), barcode.getText()))
                return;
            ClearForm();
        }
        catch (Exception ex) {
